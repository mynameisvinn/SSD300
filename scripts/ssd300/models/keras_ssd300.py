...
from keras.layers import Input, Lambda, Activation, Conv2D, MaxPool2D, MaxPooling2D, ZeroPadding2D, Reshape, Concatenate, Dense, Flatten, Dropout
...
def VGG_16(img_height, img_width, img_channels, n_classes, l2_reg=0.0005, weights_path=None):
    ...
    if weights_path:
        output.load_weights(weights_path)
